...
def write_in_files(csv_path: str, products: list[Product]) -> None:
...
def parser_for_page(driver: webdriver) -> list[Product]:
    ...
    for products_item in products_items:
        product = parse_single_product(products_item)
...
def get_all_products() -> None:
    ...
    write_in_files("home.csv", homepage_products)
    ...
    for category in categories:
        ...
        write_in_files(f"{category.lower()}.csv", products)
