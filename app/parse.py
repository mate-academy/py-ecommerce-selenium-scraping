...
def get_all_product_from_page(url: str) -> list[Product]:
    driver = get_driver()
    driver.get(url)
    try:
...
def write_info_to_file(file_name: str, url: str) -> None:
    all_products = get_all_product_from_page(url)
...
def get_all_products() -> None:
    with webdriver.Chrome() as new_driver:
        ...
        write_info_to_file("home.csv", HOME_URL)
        write_info_to_file("computers.csv", COMPUTERS_URL)
        write_info_to_file("laptops.csv", LAPTOPS_URL)
        write_info_to_file("tablets.csv", TABLETS_URL)
        write_info_to_file("phones.csv", PHONES_URL)
        write_info_to_file("touch.csv", TOUCH_URL)
